      ...
      <div class="sidebar-wrapper">
        <nav class="mt-2">
          <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview">
            ...
            {{-- ==================== Grup Laporan ==================== --}}
            @php
              $laporanActive = Route::is('kepdin.laporan.*') 
                            || Route::is('kepdin.penghapusan.*') 
                            || Route::is('penghapusan_atk.*')
                            || Route::is('laporan.perbaikan*')
                            || Route::is('laporan.report*')
                            || Route::is('kepdin.pengajuan*');
            @endphp
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{ route('kepdin.pengajuan.index') }}"
                     class="nav-link {{ Route::is('kepdin.pengajuan*') ? 'active' : '' }}">
